...
public class MapData extends DataReader
{
    ...
    private Vector<Hashtable<String, String>> events = null;
    ...
    /**
     * Each element of vector is an event
     * @return
     */
    public Vector<Hashtable<String, String>> getEvents(){
        return events;
    }
    /**
     * @throws Exception
    ...
    private void setEvent() {
        ...
        final Vector<String> lines = constructWithTag("EVENTS");
        ...
        for(int i = 0; i < lines.size();i++){
            ...
            if(!line.startsWith("#")) {
                if(line.equals("[EVENT]")) {
                    ...
                    parsingMap = false;
                    if(events == null){
                        events = new Vector<Hashtable<String,String>>();
                    }
                    events.add(tableEvt);
                    tableEvt = null;
                } else 
    ...
    private void constructMap() {
        final Vector<String> mapTmp = constructWithTag("MAP");
